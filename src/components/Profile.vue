        ...
        <div class="grid">
            ...
            <div>
                <ul>
                    ...
                    <li v-if="profileData.segments[0].stats.kills.displayValue">
                        <h4>Kills</h4>
                        <p>{{profileData.segments[0].stats.kills.displayValue}}</p>
                    </li>
                    <li v-if="profileData.segments[0].stats.level.displayValue">
                        <h4>Apex level</h4>
...
export default {
    ...
    async created()
    {
        this.loading = true;
        try{
          //Получение URL и запись данных из них в profileData
